...
## EDA
# load data
file<- "C:\\Users\\Steve\\Desktop\\School\\IST 707 Data Analytics ML\\Project\\fake_job_postings.csv"
...
#write.csv(Jobs, 'C:\\Users\\Steve\\Desktop\\School\\IST 707 Data Analytics ML\\Project\\JobsBinary.csv', row.names=FALSE)
...
write.csv(smallJobs, 'C:\\Users\\Steve\\Desktop\\School\\IST 707 Data Analytics ML\\Project\\smallJobs.csv', row.names=FALSE)
...
file<- "C:\\Users\\Steve\\Desktop\\School\\IST 707 Data Analytics ML\\Project\\smallJobs.csv"
Jobs <- read.csv(file, na.strings = c(""))
